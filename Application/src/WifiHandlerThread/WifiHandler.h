...
/** Wi-Fi AP Settings. */
// Note: It is highly recommended that you save your Wi-Fi details in a separate header file, "secret.h", which is not committed to Github.
#ifndef SECRET_H_
...
#define STRING_HEADER                                                                                                                                                                                  \
    "-- HTTP file downloader example --" STRING_EOL "-- " BOARD_NAME " --" STRING_EOL "-- Compiled: "__DATE__                                                                                          \
    " "__TIME__                                                                                                                                                                                        \
    " --" STRING_EOL
